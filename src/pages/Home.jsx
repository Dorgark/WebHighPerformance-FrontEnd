      ...
      try {
        ...
        produtosDaAPI.forEach((produto) => {
          ...
          if (!categoriasAgrupadas[nomeDaCategoria]) {
            categoriasAgrupadas[nomeDaCategoria] = { nome: nomeDaCategoria, produtos: [] };
          }
          categoriasAgrupadas[nomeDaCategoria].produtos.push(produto);
        });

        setCategorias(Object.values(categoriasAgrupadas));
      } catch (erro) {
      ...
      <main className="px-5">
        {estaCarregando ? (
          ...
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <h2 className="text-black font-bold text-2xl mb-6 px-2">{categoriaAtiva}</h2>
          ...
          categorias?.map((categoria) => (
            <section key={categoria.nome} className="mb-8">
              <div className="flex items-center justify-between px-4 mb-4">
                <h2 className="text-black font-bold text-xl my-4">{categoria.nome}</h2>
        ...
        >
          ...
          >
            ...
            <div className="p-6">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">{produtoModal.name}</h3>

              {produtoModal.description && (
                <p className="text-sm text-gray-500 mb-6">{produtoModal.description}</p>
              )}
